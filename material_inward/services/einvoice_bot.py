...
class EInvoiceBot:
    ...
    # ── Init ──────────────────────────────────────────────────────────────────
    def __init__(self, headless: bool = True, chromedriver_path: str = None, profile_dir: str = None):
        ...
        # EInvoiceBot instances can run at the same time without fighting
        # over Chromium's exclusive lock on --user-data-dir. Falls back to
        # the single shared folder above if not given (standalone/manual use).
