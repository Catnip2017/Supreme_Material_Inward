...
echo.
echo [4] Checking Z: drive...
if exist Z:\ (echo    OK - Z: drive mapped) else (echo    FAIL - Z: drive not mapped)
...
echo  Map Z: drive  : net use Z: \\srv-nas\spl\Material_inward /user:spl_rpa password /persistent:yes
echo ============================================================
pause